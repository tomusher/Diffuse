...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plan.starred'
        db.add_column('motes_plan', 'starred', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plan.starred'
        db.delete_column('motes_plan', 'starred')
